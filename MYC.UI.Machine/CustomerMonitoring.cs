...
{
    public partial class CustomerMonitoring : MYCControl
    {
        #region Field
        ...
        {
            cboCstModel.Params.Clear();
            cboCstModel.Params.Add("strProcCompCode", cboComp.ValueList);
            cboCstModel.BindDataSet();

            cbockCstEquip.Params.Clear();
            cbockCstEquip.Params.Add("strProcCompCode", cboComp.ValueList);
            cbockCstEquip.BindDataSet();
        }

        private void CboCstModel_TextChanged(object sender, EventArgs e)
        {
            cbockCstEquip.Params.Clear();
            cbockCstEquip.Params.Add("strProcCompCode", cboComp.ValueList);
            cbockCstEquip.BindDataSet();
        ...
        private void BindData()
        {
            ...
            SetSearchData("PROD_MODEL_ID", cboCstModel.ValueList);
            SetSearchData("PROC_EQP_ID", cbockCstEquip.ValueList);
        }
